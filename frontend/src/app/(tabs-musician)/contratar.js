...
export default function ContratarMusicianPage() {
  ...
  async function handleContratar() {
    ...
    try {
      ...
      router.push("/(tabs-musician)/home"); // volta para home do músico
  ...
  return (
    <ScrollView style={styles.container}>
      <TouchableOpacity onPress={() => router.push("/(tabs-musician)/home")} style={styles.backButton}>
